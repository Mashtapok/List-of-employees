...
export function EditModal({DefaultSchema, useStylesModal, editWorker, editableWorker, updateWorkerInform, ...props}) {
    ...
    const modalBody = (
            <div className={classes.paper}>
                <Formik
                    initialValues={
                        {
                            photo: editableWorker.photo,
                            name: editableWorker.name, surname: editableWorker.surname,
                            birthday: editableWorker.birthday, position: editableWorker.position,
                            remoteWork: editableWorker.remoteWork, city: editableWorker.city,
                            street: editableWorker.street, house: editableWorker.house, flat: editableWorker.flat
                        }
                    }
                    onSubmit={(data) => {
    ...
    return (
        <>
            <Button disabled={!props.isSelected} className={classes.button}
